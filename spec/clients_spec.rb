...
describe(Client) do
  ...
  describe("#client_name") do
    it("returns the name of the client") do
      test_client = Client.new({:client_name => "Becky", :client_phone => 1234567890, :client_id => 1})
  ...
  describe("#==") do
    it("is the same client if it has the same client name and id") do
      test_client = Client.new({:client_name => "Becky", :client_phone => 1234567890, :client_id => 1})
      test_client2= Client.new({:client_name => "Becky", :client_phone => 1234567890, :client_id => 1})
